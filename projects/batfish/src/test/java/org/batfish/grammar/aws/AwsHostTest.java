...
public class AwsHostTest {
  ...
  public void testNatIpsecVpnsShared() throws IOException {
    ...
    /*
     * NAT settings on host1 (shared version) should result in edges between tunnel interfaces and AWS VPNs not being pruned
     */
    assertThat(
        fixedPointLayer3Topology.getEdges(),
        hasItems(
  ...
  public void testNatIpsecTopologyNotShared() throws IOException {
    ...
    IpsecPeerConfigId awsVpn1 = new IpsecPeerConfigId("vpn-ba2e34a8-1-1-peer_config", "vgw-81fd279f");
    IpsecPeerConfigId awsVpn2 = new IpsecPeerConfigId("vpn-ba2e34a8-2-1-peer_config", "vgw-81fd279f");
