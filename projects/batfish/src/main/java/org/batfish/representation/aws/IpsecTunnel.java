...
final class IpsecTunnel implements Serializable {
  ...
  static IpsecTunnel create(VpnConnection.TunnelOptions ipsecTunnel, boolean isBgpConnection, VpnConnection.TunnelOptions tunnelOption, String customerGatewayId) {

    Builder builder = new Builder();

    builder.setcgwOutsideAddress(ipsecTunnel.getOutsideIpAddress());
