    ...
    getAllPeerConfigs(_process)
        ...
        .forEach(
            vniConfig -> {
              ...
              // 2. FALLBACK: If not found, check the Default VRF (where Junos usually stores global VNIs)
              if (l2Vni == null) {
...
// 3. Safety Check / Debugging
              if (l2Vni == null) {
                System.out.println("WARNING: L2 VNI " + vniConfig.getVni() + " not found in VRF " + _vrfName + " or Default VRF.");
